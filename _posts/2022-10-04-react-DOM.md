...
![image-20221004103444881](\images\2022-10-04-react-DOM\image-20221004103444881.png)
...
단순한 객체이므로 Virtual DOM이 변경될 때 Re-rendering이 발생하지 않고, 당연히 리소스가 크게 필요하지도 않다.
